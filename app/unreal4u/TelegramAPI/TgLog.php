...
namespace App\unreal4u\TelegramAPI;

use GuzzleHttp\Client;
use GuzzleHttp\ClientInterface;
use App\unreal4u\TelegramAPI\Abstracts\TelegramTypes;
use App\unreal4u\TelegramAPI\InternalFunctionality\DummyLogger;
use App\unreal4u\TelegramAPI\InternalFunctionality\TelegramDocument;
...
use App\unreal4u\TelegramAPI\Telegram\Types\File;
...
class TgLog
{
     ...
     *
     * @see App\unreal4u\TelegramAPI\Telegram\Types\File
     * @see App\unreal4u\TelegramAPI\Telegram\Methods\GetFile
     *
     * @param File $file
